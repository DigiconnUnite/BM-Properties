                                ...
                                <div class="footer-cl-3 footer-col-block">
                                    ...
                                    <div class="tf-collapse-content">
                                        <ul class="mt-10 navigation-menu-footer">
                                            <li> <a href="<?php echo htmlspecialchars($siteBasePath, ENT_QUOTES, 'UTF-8'); ?>index.php" class="caption-1 text-variant-2">Home</a> </li>
                                            <li> <a href="<?php echo htmlspecialchars($siteBasePath, ENT_QUOTES, 'UTF-8'); ?>about.php" class="caption-1 text-variant-2">About</a> </li>
                                            
                                            <li> <a href="<?php echo htmlspecialchars($siteBasePath, ENT_QUOTES, 'UTF-8'); ?>gallery.php" class="caption-1 text-variant-2">Gallery</a> </li>
                                            <li> <a href="<?php echo htmlspecialchars($siteBasePath, ENT_QUOTES, 'UTF-8'); ?>properties.php" class="caption-1 text-variant-2">Properties</a> </li>
                                            <li> <a href="<?php echo htmlspecialchars($siteBasePath, ENT_QUOTES, 'UTF-8'); ?>contact.php" class="caption-1 text-variant-2">Contact</a> </li>
                                        </ul>
                                    </div>
                ...
                <div class="bottom-footer">
                    <div class="container">
                        <div class="content-footer-bottom">
                            <div class="copyright">© <?php echo date('Y'); ?> <a href="index.php">BM Properties</a>. All Rights Reserved.</div>
                            <div class="developed-by">Developed by <a href="https://digiconnunite.com/" target="_blank">Digiconn Unit Pvt Ltd</a></div>
