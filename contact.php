    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
            ...
            <section class="flat-section">
                <div class="container">
                    <div class="tf-faq">
                        <div class="box-title style-1 text-center wow fadeInUpSmall" data-wow-delay=".2s"
                        ...
                        <ul class="box-faq" id="wrapper-faq">
                            <li class="faq-item">
                                <a href="#accordion-faq-one" class="faq-header collapsed" data-bs-toggle="collapse"
                                    ...
                                    What services does BM Real Estate provide?
                                </a>
                            ...
                            <li class="faq-item active">
                                <a href="#accordion-faq-two" class="faq-header" data-bs-toggle="collapse"
                                    ...
                                    Are the listed projects verified and trustworthy?
                                </a>
                            ...
                            <li class="faq-item">
                                <a href="#accordion-faq-three" class="faq-header collapsed" data-bs-toggle="collapse"
                                    ...
                                    Do you deal only in under-construction properties?
                                </a>
                            ...
                            <li class="faq-item">
                                <a href="#accordion-faq-four" class="faq-header collapsed" data-bs-toggle="collapse"
                                    ...
                                    How can I book or inquire about a property?
                                </a>
                            ...
                            <li class="faq-item">
                                <a href="#accordion-faq-five" class="faq-header collapsed" data-bs-toggle="collapse"
                                    ...
                                    Is site visit assistance available?
                                </a>
