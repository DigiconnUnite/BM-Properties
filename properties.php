...
<body class="body">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
            ...
            <section class="flat-title-page page-title-properties">
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul class="breadcrumb">
                            <li><a href="index.php" class="text-white">Home</a></li>
                            <li class="text-white">/ Properties</li>
                        </ul>
                        <h1 class="text-center text-white title">All Properties</h1>
                    </div>
                </div>
            </section>
            ...
            <section class="flat-section properties-page-section d-none">
                <div class="container">
                    <div class="box-title text-center properties-page-head wow fadeInUp" data-wow-delay=".1s">
                        <div class="text-subtitle text-primary">Featured Collection</div>
                        <h3 class="title mt-4">Explore All Listed Projects</h3>
                    </div>

                    <div class="row properties-page-grid wow fadeInUp" data-wow-delay=".2s">
                        <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                            <div class="homelengo-box properties-page-card">
                                <div class="archive-top">
                                    <a href="property-details.php" class="images-group">
                                        ...
                                        <div class="bottom">Grand Green Valley</div>
                                    </a>
                                </div>
                            ...
                            <div class="homelengo-box properties-page-card">
                                <div class="archive-top">
                                    <a href="property-details.php" class="images-group">
                                        ...
                                        <div class="bottom">UPSIC Govt Project</div>
                                    </a>
                                </div>
                                <div class="archive-bottom">
                                    <div class="content-top">
                            ...
                            <div class="homelengo-box properties-page-card">
                                <div class="archive-top">
                                    <a href="property-details.php" class="images-group">
                                        ...
                                        <div class="bottom">Green Valley Empire</div>
                                    </a>
                                </div>
                                <div class="archive-bottom">
                                    <div class="content-top">
                            ...
                            <div class="homelengo-box properties-page-card">
                                <div class="archive-top">
                                    <a href="property-details.php" class="images-group">
                                        ...
                                        <div class="bottom">Dream Avenue</div>
                                    </a>
                                </div>
                                <div class="archive-bottom">
                                    <div class="content-top">
                            ...
                            <div class="homelengo-box properties-page-card">
                                <div class="archive-top">
                                    <a href="property-details.php" class="images-group">
                                        ...
                                        <div class="bottom">Landmark City</div>
                                    </a>
                                </div>
                                <div class="archive-bottom">
                                    <div class="content-top">
                            ...
                            <div class="homelengo-box properties-page-card">
                                <div class="archive-top">
                                    <a href="property-details.php" class="images-group">
                                        ...
                                        <div class="bottom">Vrindavan Global</div>
                                    </a>
                                </div>
                                <div class="archive-bottom">
                                    <div class="content-top">
