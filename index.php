                                        ...
                                        <div class="content-top">
                                            ...
                                            <ul class="meta-list top-feature-meta-list">
                                                <li class="item">
                                                    ...
                                                    <span class="text-variant-1">24x7 Security</span>
                                                    <!-- <span class="fw-6">3</span> -->
                                                </li>
                                                <li class="item">
                                                    <i class="fa-solid fa-faucet"></i>
                                                    <span class="text-variant-1">Water Supply</span>
                                                    <!-- <span class="fw-6">2</span> -->
                                                </li>
                                                <li class="item">
                                                    <i class="fa-solid fa-tree"></i>
                                                    <span class="text-variant-1">Park</span>
                                                    <!-- <span class="fw-6">1150</span> -->
                                                </li>
                                            </ul>
                                            <div class="location">
                                        ...
                                        <div class="content-top">
                                            ...
                                            <ul class="meta-list top-feature-meta-list">
                                                <li class="item">
                                                    ...
                                                    <span class="text-variant-1">Temple</span>
                                                    <!-- <span class="fw-6">3</span> -->
                                                </li>
                                                <li class="item">
                                                    <i class="fa-solid fa-shield-halved"></i>
                                        ...
                                        <div class="content-top">
                                            ...
                                            <ul class="meta-list top-feature-meta-list">
                                                ...
                                                <li class="item">
                                                    ...
                                                    <span class="text-variant-1">Banquet hall</span>
                                                    <!-- <span class="fw-6">2</span> -->
                                                </li>
                                                <li class="item">
                                ...
                                <div class="homelengo-box top-properties list-style-1 wow fadeInUp" data-wow-delay=".4s">
                                    <div class="archive-top">
                                        <a class="images-group">
                                            ...
                                            <div class="top">
                                                <ul class="d-flex gap-6 flex-wrap">
                                                    <li class="flag-tag primary">The Grand Green Valley</li>
                                                    <!-- <li class="flag-tag style-1">For Sale</li> -->
                                                </ul>
                                            </div>
                                        </a>
                                        ...
                                        <div class="content-top">
                                            ...
                                            <ul class="meta-list top-feature-meta-list">
                                                ...
                                                <li class="item">
                                                    ...
                                                    <span class="text-variant-1">Indoor Games</span>
                                                    <!-- <span class="fw-6">1150</span> -->
                                                </li>
                                            </ul>
                                            <div class="location">
                ...
                <div class="container">
                    <div class="box-title px-15">
                        <div class="text-center wow fadeInUp">
                            ...
                            <h3 class="title mt-4">What people says</h3>
